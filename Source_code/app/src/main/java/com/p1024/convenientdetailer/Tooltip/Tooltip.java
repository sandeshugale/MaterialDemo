package com.p1024.convenientdetailer.Tooltip;
...
public final class Tooltip {
    ...
    static class TooltipViewImpl extends ViewGroup implements TooltipView {
        ...
        private String mStrTextColor = null;
        ...
        public TooltipViewImpl(Context context, final Builder builder) {
            ...
            this.mStrTextColor = builder.mStrTextColor;
        ...
        private void initializeView() {
            ...
            if (mStrTextColor != null) {
                mTextView.setTextColor(Color.parseColor(mStrTextColor));
        ...
        private void startFloatingAnimations() {
            ...
            set.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (isAttached()) {
                        Utils.log(TAG, VERBOSE, "animation restart");
                        animation.start();
                    }
                }
            });
...
//            Utils.log(TAG, VERBOSE, "[%d] onMeasure myWidth: %d, myHeight: %d", mToolTipId, myWidth, myHeight);
    ...
    public static final class Builder {
        ...
        public Builder setTextColor() {
            throwIfCompleted();
            TooltipViewImpl.mTextView.setTextColor(Color.parseColor("#FFFFFF"));
            return this;
        }
        ...
        public Builder setTextColor(String mStrTextColor) {
            throwIfCompleted();
            this.mStrTextColor = mStrTextColor;
            return this;
        }
       ...
       /* @SuppressWarnings("unused")
        public Builder anchor(final ImageView point, final int gravity) {
            throwIfCompleted();
            this.view = null;
